...
(function (window, document, $) {
    ...
    function bindTotalsToggle() {
        $(document).off('click.vmFinTotals', '.white-success-button, .vm-opr-totals-btn:not(.vm-dmt-totals-btn):not(.vm-mpos-totals-btn):not(.vm-aeps-totals-btn):not(.vm-pancard-totals-btn):not(.vm-pancard-new-totals-btn):not(.vm-pancard-manual-totals-btn):not(.vm-microatm-totals-btn):not(.vm-cashdeposit-totals-btn):not(.vm-ticket-totals-btn):not(.vm-cancel-totals-btn):not(.vm-bus-totals-btn):not(.vm-hotel-totals-btn):not(.vm-hotel-cancel-totals-btn):not(.vm-irctc-totals-btn):not(.vm-radiant-totals-btn)').on('click.vmFinTotals', '.white-success-button, .vm-opr-totals-btn:not(.vm-dmt-totals-btn):not(.vm-mpos-totals-btn):not(.vm-aeps-totals-btn):not(.vm-pancard-totals-btn):not(.vm-pancard-new-totals-btn):not(.vm-pancard-manual-totals-btn):not(.vm-microatm-totals-btn):not(.vm-cashdeposit-totals-btn):not(.vm-ticket-totals-btn):not(.vm-cancel-totals-btn):not(.vm-bus-totals-btn):not(.vm-hotel-totals-btn):not(.vm-hotel-cancel-totals-btn):not(.vm-irctc-totals-btn):not(.vm-radiant-totals-btn)', function () {
