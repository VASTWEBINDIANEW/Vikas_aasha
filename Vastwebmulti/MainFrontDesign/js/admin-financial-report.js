...
(function (window, document, $) {
    ...
    function bindTotalsToggle() {
        $(document).off('click.vmFinTotals', '.white-success-button, .vm-opr-totals-btn:not(.vm-dmt-totals-btn):not(.vm-mpos-totals-btn):not(.vm-aeps-totals-btn):not(.vm-pancard-totals-btn):not(.vm-pancard-new-totals-btn):not(.vm-pancard-manual-totals-btn)').on('click.vmFinTotals', '.white-success-button, .vm-opr-totals-btn:not(.vm-dmt-totals-btn):not(.vm-mpos-totals-btn):not(.vm-aeps-totals-btn):not(.vm-pancard-totals-btn):not(.vm-pancard-new-totals-btn):not(.vm-pancard-manual-totals-btn)', function () {
